...
<body>
    <form id="form1" runat="server">
        <span style="font-size: 30px; cursor: pointer" onclick="openNav()">&#9776;</span><a class="categories" href="Home.aspx" style="color: white; text-decoration: none;"></a>
        <div id="mySidenav" class="sidenav">
            <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a><br />
            <br />
            <strong>
                <p style="color: white; text-align: center; position: static; padding-top: 5px; padding-bottom: 5px; font-size: 15px; background-color: white; color: black;">Accounts & Lists</p>
            </strong>
            <br />
            <br />
            <br />
            <asp:Button runat="server" ID="profile_back" class="btn btn-light" Text="Homepage" OnClick="profile_back_Click" CausesValidation="false" /><br />
            <br />  
            <asp:Button runat="server" ID="profile_wishlist" class="btn btn-light" Text="Wishlist" OnClick="profile_wishlist_Click" CausesValidation="false" /><br />
            <br />
            <asp:Button runat="server" ID="profile_buying" class="btn btn-light" Text="Buying" OnClick="profile_buying_Click" CausesValidation="false" /><br />
            <br />
            <asp:Button runat="server" ID="profiel_selling" class="btn btn-light" Text="Selling" OnClick="profile_selling_Click" CausesValidation="false" /><br />
            <br />
            <asp:Button runat="server" ID="profile_sell_item" class="btn btn-light" Text="Sell Item" OnClick="profile_sell_item_Click" /><br />
            <br />
            <asp:Button runat="server" ID="profile_cart" class="btn btn-light" Text="Cart" OnClick="profile_cart_Click" CausesValidation="false" /><br />
            <br />
            <asp:Button runat="server" ID="profile_information" class="btn btn-light" Text="Profile Information" OnClick="profile_information_Click" CausesValidation="false" /><br />
        </div>
        <div class="main">
            <h1 id="profile-head" style="color: black;"></h1>

            <div class="profileContainer" id="profileContainer" runat="server" style="margin-left: 330px; margin-top: 100px;">
                <div class="col-md-8">
                    <div class="card mb-3">
                        <div class="card-body" style="border-color: #0096C7; border-style: groove; border-radius: 15px;">
                            <div class="row">
                                <div class="col-sm-3">
