...
namespace OceanShopping
{
    ...
    public class ItemActions : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public User GetAddresses(int userID)
        {
            SqlCommand objCommand = new SqlCommand();
            objCommand.CommandType = System.Data.CommandType.StoredProcedure;
            objCommand.CommandText = "OceanGetUser";
            ...
            if (myData.Tables[0].Rows.Count > 0)
            {
                ...
                string billingAddress = row["billingAddress"].ToString();
                string deliveryAddress = row["deliverAddress"].ToString();

                User tempUser = new User();
                tempUser.DeliverAddress = deliveryAddress;
        ...
        [WebMethod]
        public User GetCreditCard(int userID)
        {
            SqlCommand objCommand = new SqlCommand();
            objCommand.CommandType = System.Data.CommandType.StoredProcedure;
            objCommand.CommandText = "OceanGetUser";
            ...
            if (myData.Tables[0].Rows.Count > 0)
            {
                ...
                byte[] credtCard = (byte[])row["creditcard"];

                User tempUser = new User();
                tempUser.CreditCard = credtCard;
